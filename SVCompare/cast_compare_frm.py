...
class frm_compare ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		fgSizer3.Add( self.fp_ref, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL|wx.EXPAND, 5 )
		...
		fgSizer3.Add( self.fp_comp, 0, wx.ALIGN_CENTER_VERTICAL|wx.ALL|wx.EXPAND, 5 )
		...
		self.txt_lat = wx.TextCtrl( self, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 100,-1 ), 0 )
